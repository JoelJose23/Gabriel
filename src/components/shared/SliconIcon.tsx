...
// ─── Path dictionary: 24×24 viewBox, 1.5px stroke, rounded caps & joins ───────

const paths: Record<string, string> = {
  // Sidebar navigation
  home: '<path d="M4 10l8-6 8 6v10h-16z"/><path d="M10 20v-6h4v6"/>',
  ...
  workflows: '<circle cx="6" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="9" r="3"/><path d="M6 9v6"/><path d="M8.5 7.5L15.5 8.5"/>',
  ...
  appearance: '<circle cx="12" cy="12" r="9"/><circle cx="9" cy="9" r="1"/><circle cx="15" cy="9" r="1"/><circle cx="12" cy="15" r="1"/>',
  storage: '<rect x="2" y="4" width="20" height="16" rx="2"/><line x1="2" y1="10" x2="22" y2="10"/><line x1="2" y1="16" x2="22" y2="16"/><line x1="6" y1="7" x2="6.01" y2="7"/><line x1="6" y1="13" x2="6.01" y2="13"/><line x1="6" y1="19" x2="6.01" y2="19"/>',
  performance: '<path d="M3 15a9 9 0 1 1 18 0"/><path d="M12 15l-4-4"/><circle cx="12" cy="15" r="1.5"/>',
...
export type SliconName = keyof typeof paths;

interface SliconIconProps extends Omit<SVGProps<SVGSVGElement>, 'children'> {
  name: SliconName;
  size?: number;
}

/**
 * Renders a crisp 1.5px-stroke Slicon-style SVG icon by name.
 * Uses a <g> child with dangerouslySetInnerHTML — required because React
 * does not allow dangerouslySetInnerHTML directly on <svg> elements.
 * Stroke inherits currentColor so Tailwind text utilities control the color.
 */
export const SliconIcon: FC<SliconIconProps> = ({
  name,
  size = 18,
  className = '',
  ...rest
  ...
  return (
    <svg
      ...
      {...rest}
    >
      {/* React blocks dangerouslySetInnerHTML on <svg> directly;
          wrapping in <g> is the standard workaround. */}
